class HistorialesPediatricosController < ApplicationController
  ...
  load_and_authorize_resource :class => FichaPediatrica
  ...
  def set_historial
    ...
    @ficha = @paciente.ficha_pediatrica
  ...
  def print
    respond_to do |format|
        format.pdf do
          render pdf:  'Historial de Paciente (Pediatría)',
          template:    'historiales_pediatricos/print.pdf.erb',
          layout:      'pdf.html',
          title:       'Historial de Paciente (Pediatría)',
