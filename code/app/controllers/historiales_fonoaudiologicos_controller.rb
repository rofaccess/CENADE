class HistorialesFonoaudiologicosController < ApplicationController
  ...
  load_and_authorize_resource :class => FichaFonoaudiologica
  ...
  def print
    respond_to do |format|
        format.pdf do
          render pdf:  'Historial de Paciente (Fonoaudiología)',
          template:    'historiales_fonoaudiologicos/print.pdf.erb',
          layout:      'pdf.html',
          title:       'Historial de Paciente (Fonoaudiología)',
